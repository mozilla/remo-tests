...
class EditEvent(Base):
    ...
    _event_choose_goals_locator = (By.CSS_SELECTOR, '#goals-modal input[id="Firefox-OS-bit"]')
    ...
    _save_event_button_locator = (By.CSS_SELECTOR, 'button.small.button.confirm')
    ...
    def edit_event_name(self, event_name):
